...
public class Shatter : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public List<GameObject> ShatteredPieces = new List<GameObject>();

        public void MakeGameobjects(Shatter original)
        {
            GameObject piece = new GameObject(original.name);
            ...
            // Store the shattered piece
            ShatteredPieces.Add(piece);

            // Your existing code to set up the mesh, materials, collider, etc.
        }

        public void DestroyAllPieces()
        {
            foreach (GameObject piece in ShatteredPieces)
            {
                Destroy(piece, 5f);  // Destroy each shattered piece after 5 seconds
            }
        }
